...
def load():
    ...
    metainfo = database.StoredMetainfo({'NHGISNAM': dict(unit="name"), 'NHGISST': dict(unit="code"), 'NHGISCTY': dict(unit="code"), 'STATENAM': dict(unit="name"), 'solarsum': dict(unit="W"), 'solarmean': dict(unit="W/m^2"), 'windsum': dict(unit="W"), 'windmean': dict(unit="W/m^2")})
